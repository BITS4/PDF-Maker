...
internal object ImageColorMatrices {
    ...
    fun highContrastBlackAndWhite(): ColorMatrix = saturatedScale(saturation = 0f, scale = 2.1f, translation = -110f)

    fun vividDocument(): ColorMatrix = saturatedScale(saturation = 1.7f, scale = 1.3f, translation = -20f)
    ...
    fun adjustment(
        ...
        translation: Float,
    ): ColorMatrix = scale(contrastFactor, translation)

    private fun saturatedScale(
        saturation: Float,
        scale: Float,
        translation: Float,
    ): ColorMatrix =
